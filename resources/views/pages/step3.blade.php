                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Partner Name" name="partner_owner_name"  value="{{old('partner_owner_name', isset($partner) ? $partner['partner_owner_name']:'')}}">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Title " name="partner_title"  value="{{old('partner_title', isset($partner) ? $partner['partner_title']:'')}}">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Ownership %" name="partner_ownership"  value="{{old('partner_ownership',isset($partner) ? $partner['partner_ownership'] :'')}}">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <textarea type="textarea" class="form-control" placeholder="Home Address" name="partner_home_address" >
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="City" name="partner_city"  value="{{old('partner_city', isset($partner) ? $partner['partner_city']:'')}}">
                    ...
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="State" name="partner_state"  value="{{old('partner_state', isset($partner) ? $partner['partner_state']:'')}}">
                    ...
                    <div class="col-12 col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Zip" name="partner_zip"  value="{{old('partner_zip', isset($partner) ? $partner['partner_zip']:'')}}">
                            @error('partner_zip')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            name="partner_date_of_birth" value="{{isset($partner) ? $partner['partner_date_of_birth'] !=''? $partner['partner_date_of_birth'] : date("Y-m-d"): date("Y-m-d")}}">
                    ...
                    {{-- <div class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Home " name="partner_home"  value="{{old('partner_home', isset($partner) ? $partner['partner_home']:'')}}">
                            @error('partner_home')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
